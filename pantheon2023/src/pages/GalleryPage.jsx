    ...
    return (
        <>
            <div className="overflow-x-hidden bg-[#151515]">
                ...
                keywords="RNSIT Gallery, Pantheon visuals, Mystic Memoirs moments, Parichay festival highlights, Student activities showcase, Cultural clubs display, Campus life visuals, RNSIT diversity, Creative expressions, Pantheon memories, Bi-annual fest visuals, RNSITians talent, Cultural extravaganza, Campus vibrancy, Mystic Memoirs gallery, Parichay festival gallery, Pantheon fest snapshots, RNSIT events, Cultural diversity showcase, Student-led activities, RNSIT cultural clubs, Bi-annual fest captures, Campus life images." />
                <Navbar />
