                ...
                <div className="py-16 mx-auto max-w-7xl sm:py-24 sm:px-6 lg:px-8">
                    <div className="relative bg-white shadow-xl">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3">
                            {/* Contact information */}
                            <div className="relative px-6 py-10 overflow-hidden bg-[#151515] sm:px-10 xl:p-12">
                                ...
                                <dl className="mt-8 space-y-6">
                                    ...
                                    <dd className="flex-col text-base text-indigo-50">
                                        <a href="tel:9731669372">Teacher Coordinator<div>Mr. Sridhar S :- +91 97316 69372 </div></a>{" "}
