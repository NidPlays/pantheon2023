...
export default function Timer() {
  ...
  return (
    <div>
      <div
        data-aos="fade-up"
        className="timer overflow-hidden flex justify-center items-center"
        role="timer"
      >
        <div className="col-4 px-5 bg-transparent py-2">
          <div className="box">
            <p id="day" className="text-white text-3xl">
              {days < 10 ? "00" : "00"}
            </p>
            <span className="text-white text-base">Days</span>
          </div>
        ...
        <div className="px-5 bg-transparent py-2">
          <div className="box">
            <p id="hour" className="text-white text-3xl">
              {hours < 10 ? "00" : "00"}
            </p>
            <span className="text-white text-base">Hours</span>
          </div>
        ...
        <div className="px-5 bg-transparent py-2">
          <div className="box">
            <p id="minute" className="text-white text-3xl">
              {minutes < 10 ? "00" : "00"}
            </p>
            <span className="text-white text-base">Minutes</span>
          </div>
        ...
        <div className="px-5 bg-transparent py-2">
          <div className="box">
            <p id="second" className="text-white text-3xl">
              {seconds < 10 ? "00" : "00"}
            </p>
            <span className="text-white text-base">Seconds</span>
          </div>
      ...
      <br />
      <div className="text-white text-5xl">It's Happeninnggg!!!</div>
    </div>
  );
}
