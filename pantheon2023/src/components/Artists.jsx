...
import djprithvi from "../assets/djprithvi.jpg";
    ...
    const artistCarouselCard = [
        {
            id: 1,
            name: 'Brodha V',
            description: 'Brodha V is an Indian rapper, songwriter, and music producer known for his unique style that blends traditional Indian sounds with contemporary hip-hop and rap.',
        ...
        },
        {
            id: 2,
            name: 'DJ Prithvi',
            description: 'DJ Prithvi is an up-and-coming DJ known for his versatility and the ability to blend various genres seamlessly, creating a unique and energetic atmosphere in his sets.',
            button_text: 'View Profile',
            img: djprithvi,
            link: "https://www.instagram.com/djprithvi/?hl=en",
        },
        {
            id: 3,
            name: 'Shiva Manvi',
            description: "Shiva Manvi is an Indian DJ known for his contributions to the electronic dance music (EDM) scene.",
            button_text: 'View Profile',
            img: shivu,
            link: "https://www.instagram.com/shivu_rapper/?hl=en",
        },
    ];
    ...
    return (
        ...
        <div className="flex-1  w-full md:pl-0">
            <div className=" py-auto flex flex-col items-center justify-center md:items-start md:justify-start lg:w-5/6 w-full mx-auto md:gap-6 gap-2 ">
                ...
                <div className="my-4">
                <Link to={artistCardInfo[activeSlide].link} className="inline-flex h-12 animate-background-shine items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 items-center justify-center gap-2 py-3 px-12 rounded-md md:flex cursor-pointer">
                    <span className="text-lg font-medium">{artistCardInfo[activeSlide].button_text}</span>
                    <span>
                    <HiArrowRight />
                    </span>
                </Link>
