        ...
        <>
            ...
            <div className=' text-white p-10'>
                <article className='col-span-9 mt-12 justify-center flex'>
                    <div className=''>
                        <div>
                            <h1 className="text-white font-bold text-4xl md:text-5xl xl:text-6xl">name<span className="text-primary text-[#EACD69]">.</span></h1>

                            <div className='text-center'>
                                <div className='flex items-center justify-center mb-2 space-x-2 text-lg'>
                                    <p className='m-0 text-lg md:text-xl'>alias</p>
                                    <p className='m-0'>•</p>
                                    {/* <PageViews slug={slug} /> */}
                                </div>
                    ...
                    <div className="space-y-4">
                        <div className="md:p-10 ">
                            <h4 className='text-3xl  font-bold font-headings md:text-5xl'>
                                About Event.
                            </h4>                        <p className='md:p-5 text-justify mt-4'>about</p>
                        </div>
                        <div className="md:p-10">
                            <h4 className='text-3xl font-bold  font-headings md:text-5xl'>
                                Event Details.
