...
function EventDetails({ id }) {
  ...
  return (
    <>
      <SEO
        title={`${event.event_name} | Pantheon 2023`}
        description={`${event.description}`}
        canonicalUrl={`${event.event_name}`}
      />
        ...
        <article className="col-span-9 mt-12 justify-center flex">
          <div className="">
            ...
            <div className="my-12 flex flex-col items-center justify-center">
              ...
              <div className="mt-8 flex flex-col items-center justify-center space-x-4 md:w-2/3 md:flex-row md:items-center md:justify-around">
                {/* <p className="flex items-center text-gray-500 mb-4 md:mb-0"> */}
                <p className="flex items-center text-gray-500 ">
                  <svg
                    className="text-white mr-2 md:mr-4 md:w-6 md:h-6 lg:w-8 lg:h-8 bi bi-calendar-day"
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
                    fill="currentColor"
                ...
                <p className="flex items-center text-gray-500 ">
                  <svg
                    className="text-white mr-2 md:mr-4 md:w-6 md:h-6 lg:w-8 lg:h-8 bi bi-clock-fill"
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
                    fill="currentColor"
                ...
                <p className="flex items-center text-gray-500">
                  <svg
                    className="text-white mr-2 md:mr-4 md:w-6 md:h-6 lg:w-8 lg:h-8"
                    width="25"
                    height="25"
        ...
        <div className="mt-6 lg:p-10 ">
          <div className="space-y-4">
            <div className="p-5 md:p-10 ">
              ...
              <p className="md:px-5 text-justify mt-6 md:mt-8">
                <span className="font-medium text-gray-100">Category</span>{" "}
                <span className="gold-text font-bold">{event.category}</span>
              </p>
              <p className="md:px-5 text-justify mt-6 md:mt-8">
                {event.description}
              </p>
            ...
            <div className="p-5 md:p-10">
              ...
              <ul className="list-disc lg:pl-4 mt-5 ">
                ...
                <li className="lg:p-2 text-justify lg:ml-10">
                  <span className="font-medium text-gray-400">Time Limit</span>{" "}
              ...
              <div className="space-y-2 mt-5">
                {event?.coordinator?.map((item, index) => (
                  <p className="lg:p-2 lg:ml-10 text-justify" key={index}>
                    ...
                    {item.name.includes(" ") ? (
                      <>
                        {item.name.split(" ")[0]} <br className="lg:hidden" />{" "}
                        {item.name.split(" ")[1]} (
