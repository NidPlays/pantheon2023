    ...
    return (
        <div className='flex items-center w-full h-screen custom-css-about '>
            ...
            <div className="w-2/3 text-justify mx-auto">
                <h1 className="text-white text-center dark:text-white font-bold text-4xl md:text-6xl xl:text-7xl logo-text-abt">Pantheon<span className="text-primary bg-custom-gradient"> 2023</span></h1>
